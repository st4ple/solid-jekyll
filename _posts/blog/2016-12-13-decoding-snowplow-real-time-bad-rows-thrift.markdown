...
description: Step by step the instructions in Python as to how to first decode, and then deserialize bad rows data that comes out of Snowplow real time.
...
tags: Snowplow Analytics bad rows, Snowplow thrift records,
---
